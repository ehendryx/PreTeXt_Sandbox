...
var ptx_lunr_docs = [
{
  ...
  "type": "Worksheet",
  "number": "",
  "title": "Brief Course Introduction",
  "body": " Brief Course Introduction      Where have you seen math applied in other courses or even daily life?      Using mathematical theory, notation, methods, and tools to answer practical questions is a form of .    One important skill to succeed in this class and beyond is abstraction :     the realization that the letter in an equation might represent the physical size of a cell, the cost of a sweater, the size of a population, the age of a company, etc.    the understanding that although we are interested in a specific application problem, we have to carefully apply the rules of mathematics to achieve a solution---we solve an equation the same way whether or not it is purely a mathematical problem or represents a real-world problem    the recognition that many visibly different applied problems might be linked by the same mathematical description, and that what we learn from one system\/situation could teach us about another---even though we might not recognize any direct real-world similarities between the two systems      "
},
{
  "id": "course_intro_notes-2-1",
  "level": "2",
  "url": "course_intro_notes.html#course_intro_notes-2-1",
...
{
  "id": "course_intro_notes-2-2",
  "level": "2",
  "url": "course_intro_notes.html#course_intro_notes-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
{
  "id": "course_intro_notes-2-3",
  "level": "2",
  "url": "course_intro_notes.html#course_intro_notes-2-3",
